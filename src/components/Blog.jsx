            ...
            <div className="container mx-auto">
                ...
                <div className="lg:flex gap-10 items-center justify-center pt-[100px] ">
                    <div className="space-y-6">
                        ...
                        <h1 className="text-4xl text-white font-semibold mb-4">Future Technology Blog</h1>
                ...
                {/* Second Section */}
                {/* <div className="lg:flex gap-10 items-center justify-center pt-[60px] ">
                    <div className="space-y-6">
                        <img src="https://i.ibb.co/DVTX1TY/Icon-1.png" alt="" />
                        <h1 className="text-4xl text-white font-semibold mb-4">Research Insights Blogs</h1>
                    ...
                    <div className="grid gap-4 rounded-lg grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        <div className="bg-[#191919] p-6 rounded-lg border-dashed border">
                            <h1 className="text-3xl font-semibold text-white">Depth</h1>
                            <p className="pt-3">500+ research articles for in-depth understanding.</p>
                        </div>
                        <div className="bg-[#191919] p-6 rounded-lg border-dashed border">
                            <h1 className="text-3xl font-semibold text-white">Graphics</h1>
                            <p className="pt-3">Visual aids and infographics to enhance comprehension.</p>
                        </div>
                        <div className="bg-[#191919] p-6 rounded-lg border-dashed border">
                            <h1 className="text-3xl font-semibold text-white">Trends</h1>
                            <p className="pt-3">Explore emerging trends in future technology research.</p>
                        </div>
                        <div className="bg-[#191919] p-6 rounded-lg border-dashed border">
                            <h1 className="text-3xl font-semibold text-white">Contributors</h1>
                            <p className="pt-3">Contributions from tech researchers and academics.</p>
                        </div>
                    </div>
                </div> */}
            </div>
