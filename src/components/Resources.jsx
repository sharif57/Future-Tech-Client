...
const Resources = () => {
    ...
    return <div className="bg-[#141414]">
        <div className="container mx-auto ">
            ...
            {
                items.map(item => (
                    <div key={item._id} className="lg:flex  justify-between  items-center gap-10 lg:pt-16 pb-16 p-4">
                        ...
                        <div className="">
                            ...
                            <video src={item.video} controls autoPlay autoFocus className="w-full lg:h-96 h-48 object-cover rounded-lg">
            ...
            {/* <div className="flex  justify-between  items-center gap-10 pt-16 pb-16">
                ...
                <div className="">
                    ...
                    <video src="/video-1.mp4" controls autoPlay autoFocus className="w-full h-96 object-cover rounded-lg">
                        Your browser does not support the video tag.
                    </video>
